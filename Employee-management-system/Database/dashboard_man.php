  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-3 mb-4">
        <a href="add_report.php" class="card bg-danger text-decoration-none">
          <div class="card-body">
      ...
      <div class="col-md-3 mb-4">
        <a href="retrieve_employees.php" class="card bg-warning text-decoration-none">
          <div class="card-body">
            <h5 class="card-title">Mark Absence</h5>
          </div>
        </a>
      </div>

      <div class="col-md-3 mb-4">
        <a href="assignTasks.php" class="card bg-success text-decoration-none">
          <div class="card-body">
      ...
      <div class="col-md-3 mb-4">
        <a href="viewEmployees.php" class="card"
          style="background-color: #7c0080; color: white; text-decoration: none;">
          <div class="card-body">
      ...
      <div class="col-md-3 mb-4">
        <a href="Requested_vacations_manager.php" class="card"
          style="background-color: #ff0080; color: #ffffff; text-decoration: none;">
          <div class="card-body">
