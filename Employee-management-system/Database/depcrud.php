                        ...
                        if (!$result) {
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['emps_number']; ?></td>
                                    <td>
                                        <a href="update_dep.php?id=<?php echo $row['department_id']; ?>" class="edit"><i
                                                class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="delete_dep.php?id=<?php echo $row['department_id']; ?>" class="delete"
                ...
                <form action="insert_dep.php" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="int" name="manager_id" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="emps_number" class="form-control" required>
                        </div>
                        <!-- add and cancel buttons -->
                        <div class="modal-footer">

                            <input type="submit" class="btn btn-success" name="add_dep" value="Add">
                        </div>
                </form>
            </div>
        </div>
